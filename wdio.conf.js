...
export const config = {
    ...
    reporters: [
        ...
        ['cucumberjs-json', {
            jsonFolder: './reports/json', // Directory to store JSON reports
            language: 'en', // Language of Gherkin feature files (optional, default is 'en')
        }],],

    // If you are using Cucumber you need to specify the location of your step definitions.
    cucumberOpts: {
        // <string[]> (file/dir) require files before executing features
        require: ['./UI_Tests/step-definitions/steps.js'],
